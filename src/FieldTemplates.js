...
export const FieldTemplates = {
  ...
  inputFields: [
    ...
    string: (props, cb) => {
      ...
      const dynamicData = FieldTemplates.mistForm.dynamicFieldData[_props.fieldPath];
  ...
  ,
    object: (props) => {
      ...
      if (FieldTemplates.mistForm.getSubformState(props.fieldPath) === undefined) {
      ...
      >
        ...
        html` <paper-toggle-button
          ...
          .checked="${showFields}"
          @checked-changed="${e => {
            FieldTemplates.mistForm.setSubformState(props.fieldPath, e.detail.value);
