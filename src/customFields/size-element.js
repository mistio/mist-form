...
class SizeElement extends LitElement {
  ...
  static get styles() {
    return css`
      ...
      .sizeRow > paper-dropdown-menu, .sizeRow > .sizeField {
        width: 89%;
      }
      .label {
        margin-top: auto;
  ...
  validate() {
    ...
    return this.value.every(item => Object.prototype.hasOwnProperty.call(item, 'cloud') && Object.prototype.hasOwnProperty.call(item, 'size'));
  }
  ...
  render() {
    return html` <span class="label">${this.label}</span><div style="width:100%">
        ...
        <div class="sizeRow">
           <paper-dropdown-menu
              ...
              <paper-listbox
                 ...
                 ${this.clouds.map(
                 cloud => html`
                 <paper-item value="${cloud.id}">${cloud.title}</paper-item>
                 `
                 )}
              </paper-listbox>
           </paper-dropdown-menu>
